...
// opts: { autoFulfilled, exempt, preChecked, preWaived, credits }
...
function makeRow(rowId, prefix, codeHTML, descHTML, opts) {
  ...
  <td class="col-course"><input type="text" placeholder="e.g. ENG 101" data-id="${rowId}" data-field="course"></td>
  <td class="col-hrs"><input type="text" inputmode="numeric" placeholder="—" data-id="${rowId}" data-field="hrs"${hrsVal}${hrsReadOnly}></td>
